...
| 2a    | Bike route beside cars    | Painted bike lane or shared bus lane on a quiet street (speed ≤ 30 km/h) | blue `#2b8cbe`        | solid            | 0.6×        |
| 2b    | Quiet residential street  | Quiet residential street with no bike infra, speed ≤ 30 km/h.  Separate category because I don’t know how reliably “quiet” these are | pink `#e78ac3`        | solid            | 0.6×        |
| 3     | Higher traffic street     | Streets with speed limit between 30-50kmh, with or without a painted bike lane.  And 3 lanes or less in each direction.This is close to but slightly less nuanced than LTS at the moment | yellow `#ffd92f`      | solid            | 0.6×        |
