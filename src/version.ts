 ...
 *
 * Single source of truth for the UI, Sentry releases, PostHog register,
 * and Userback custom_data. Benchmark folders also embed the short
 * version string so a result can be traced back to the exact bundle
 * that produced it.
 *
